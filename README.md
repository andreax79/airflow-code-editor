...
* andreax79/airflow-code-editor:**3.3.0** - the latest released Airflow Code Editor with specific Airflow version
* andreax79/airflow-code-editor:**3.3.0-8.3.0** - specific version of Airflow and Airflow Code Editor
